...
struct StyleConstants {
    ...
    struct FavouritesCollectionViewCellLengths {
        static let collectionCellHeight = 160.0
        static let collectionCellWidth = 113.0
        static let favouritesButtonSize = 32.0
        static let favouritesButtonOffset = 9.0
        static let cellEdgeRadius = 10.0
        static let spaceLengthSmall = 15.0
        static let spaceLengthLarge = 35.0
    }
